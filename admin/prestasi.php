...
/* ======================================================
   4. AMBIL DATA LIST PRESTASI
   ====================================================== */
$queryList = mysqli_query($conn, "SELECT * FROM prestasi ORDER BY id DESC");
...
<div class="breadcrumb">
    <a href="prestasi.php" class="breadcrumb-link">Prestasi</a> / 
    <?php if ($mode == "list"): ?>
        <span class="breadcrumb-text">Daftar Prestasi</span>
    <?php elseif ($mode == "tambah"): ?>
        <a href="prestasi.php" class="breadcrumb-link">Tambah Prestasi</a>
    <?php elseif ($mode == "edit"): ?>
        <a href="prestasi.php" class="breadcrumb-link">Edit Prestasi</a>
    <?php endif; ?>
</div>
